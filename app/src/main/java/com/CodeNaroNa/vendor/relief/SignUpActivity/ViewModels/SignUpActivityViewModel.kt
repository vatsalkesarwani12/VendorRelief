...
@Suppress("unused")
class SignUpActivityViewModel(private val applicationContext: Context, private val centralRepository: CentralRepository) : ViewModel() {
    ...
    fun signInUser(enteredOTP: String, userType: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                centralRepository.signUpNewVendor(modifiedPhoneNumber)
